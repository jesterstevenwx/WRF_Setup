...
seqs = ['real', *(x for x in range(1,49))] #must contain 'real' at the beginning, if using ndown: must include 'ndown' as a sequence
sdays = [20, *(x for x in range(20,32) for _ in (0,1)), *(x for x in range(1,13) for _ in (0,1))] #must contain the start for entire sim at beginning, must have start twice for ndown
edays = [13, 20, *(x for x in range(21,32) for _ in (0,1)), *(x for x in range(1,13) for _ in (0,1)), 13] #must have end of entire sim at beginning, must have end twice for ndown
